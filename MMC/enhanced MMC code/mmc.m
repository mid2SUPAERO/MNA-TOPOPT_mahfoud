...
F=sparse(loaddof,1,-1,2*(nely+1)*(nelx+1),1); % Cantilever
...
while Loop<maxiter  && kktnorm>kkttol && change>0.001
    ...
    P=40; % parameter for KS function
...
figure;
subplot(2,2,1)
scatter(list_iter,list_comp,4)
xlabel('iteration') ; ylabel('compliance')
title('compliance history')
subplot(2,2,2)
scatter(list_iter,list_vol,4)
xlabel('iteration') ; ylabel('volume')
title('volume history')
subplot(2,2,3)
scatter(list_iter,list_kktnorm,4)
